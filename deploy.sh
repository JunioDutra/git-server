...
ssh -o StrictHostKeyChecking=accept-new -o ConnectTimeout=10 "$PROX_TARGET" \
  "pct exec $GIT_CONTAINER_ID -- sh -c 'cat > $CT_DIR/homepage_stats.py.new'" < "$SCRIPT_DIR/homepage_stats.py"
ssh -o StrictHostKeyChecking=accept-new -o ConnectTimeout=10 "$PROX_TARGET" \
...
ssh -o StrictHostKeyChecking=accept-new -o ConnectTimeout=10 "$PROX_TARGET" \
  "pct exec $GIT_CONTAINER_ID -- python3 -m py_compile $CT_DIR/app.py.new $CT_DIR/homepage_stats.py.new $CT_DIR/repository_variables.py.new $CT_DIR/configure_build_env.py.new /home/git/hooks/build_image.py.new /home/git/hooks/build_submit.py.new /home/git/hooks/build_dispatcher.py.new /home/git/hooks/repository_variables.py.new" 2>&1
ssh -o StrictHostKeyChecking=accept-new -o ConnectTimeout=10 "$PROX_TARGET" \
